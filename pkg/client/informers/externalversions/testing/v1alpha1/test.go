...
import (
	...
	versioned "github.com/distributed-containers-inc/knoci/pkg/client/clientset/versioned"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TestingV1alpha1().Tests(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TestingV1alpha1().Tests(namespace).Watch(options)
			},
		},
		&testingv1alpha1.Test{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *testInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&testingv1alpha1.Test{}, f.defaultInformer)
}
