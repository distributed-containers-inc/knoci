...
import (
	v1alpha1 "github.com/distributed-containers-inc/knoci/pkg/apis/testing/v1alpha1"
	"github.com/distributed-containers-inc/knoci/pkg/client/clientset/versioned/scheme"
...
// TestingV1alpha1Client is used to interact with features provided by the testing group.
type TestingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TestingV1alpha1Client) Tests(namespace string) TestInterface {
